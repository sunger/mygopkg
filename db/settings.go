...
type SettingCate struct {
	...
	//模块代码
	ModuleCode string `gorm:"column:mcode;type:varchar(50);"`
	//名称
...
type Settings struct {
	//分类id
	Cate string `gorm:"column:cate;type:varchar(50);"`
	//控件json
	Ctrl string `gorm:"column:ctrl;type:varchar(500);"`
	//Value
	Val string `gorm:"column:v;type:varchar(250);"`
	//显示排序
	Idx int `gorm:"column:idx;"`
	model.BModel
}
