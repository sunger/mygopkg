...
## 安装
* go get -u github.com/sunger/goft-expr@v0.3.0
...
import (
	"fmt"
	"github.com/sunger/goft-expr/src/expr"
)
...
Released under the [Apache License 2.0](https://github.com/sunger/goft-expr/blob/master/LICENSE)
